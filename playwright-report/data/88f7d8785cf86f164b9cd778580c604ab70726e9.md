...
- Name: Verificación automatizada de PyXom >> Cargar y testear ruta /
...
Locator: getByText('Convocatoria Extraordinaria 2025')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for getByText('Convocatoria Extraordinaria 2025')

    at C:\Users\xabie\Desktop\pyxom\tests\verify.spec.ts:25:76
```
