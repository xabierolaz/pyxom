...
import { courseParts, getPartProgress, getOverallProgress } from '@/data/courseData';
    ...
    return (
      <div className="max-w-4xl mx-auto p-6">
        <div className="text-center py-12">
          <h1 className="text-3xl font-bold text-slate-800 mb-4">Acceso Requerido</h1>
          <p className="text-slate-600 mb-8">Debes iniciar sesión para ver tu progreso.</p>
